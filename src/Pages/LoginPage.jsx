            ...
            <div className="form_contaner">
                <div className="header_greeting">
                    ...
                    <form className="form_style">
                        ...
                        <input className="input_style" name="password" type="password" placeholder="Введите свой пароль" />
                        <label className="checkbox_style_login" ><input type="checkbox"  placeholder="Запомните меня"/> Запомните меня </label>
