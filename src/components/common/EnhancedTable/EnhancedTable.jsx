...
function createData(name, surname, county, sex, docNumber,hoursNumber,enrollment) {
  return {
    name,
    surname,
    county,
...
export default function EnhancedTable() {
  ...
  return (
    <Box sx={{ width: '1400px', marginLeft:'auto',marginRight:'auto', paddingTop: '30px'}}>
      <Paper sx={{ width: '100%', mb: 2 ,boxShadow:'none',borderBottom: '1px solid #FA7A45',borderRadius: '0px',borderTop: '1px solid #FA7A45'}}>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.hoursNumber}</TableCell>
